	...
	var View = function () {
	    ...
	    _createClass(View, [{
	        ...
	        value: function renderOrderList(newMeal, newCalories, newTotal) {
	            ...
	            this.elements.orderTable.appendChild(cap);

	            this.elements.orderTable.appendChild(trow);

	            cap.innerHTML = "Total Calories:" + newTotal;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Controller = function () {
	    ...
	    _createClass(Controller, [{
	        key: "copy",
	        value: function copy(meal, calories, total) {
...
/***/ (function(module, exports) {
	...
	var Observer = function () {
	    ...
	    _createClass(Observer, [{
	        ...
	        key: "notify",
	        value: function notify(meal, calories) {
